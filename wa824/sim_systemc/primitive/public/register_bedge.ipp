template <int N>
thpg::primitive::RegisterBEdge<N>::RegisterBEdge(sc_module_name name)
	: sc_module(name)
{
	SC_METHOD(read);
	sensitive << cs << wr_bar;
...
template <int N>
void thpg::primitive::RegisterBEdge<N>::read(void)
{
	[&] {
...
template <int N>
void thpg::primitive::RegisterBEdge<N>::write(void)
{
	[&]{
