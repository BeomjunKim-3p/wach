...
export module primitive.register_file_bedge;

import primitive.register_bedge;
...
export namespace thpg::primitive {
	...
	class RegisterFileBEdge : public sc_module {
	public:
		...
		RegisterFileBEdge(sc_module_name name, sc_trace_file *tf = nullptr);
...
#include "register_file_bedge.ipp"
