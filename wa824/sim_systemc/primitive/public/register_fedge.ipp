template <int N>
thpg::primitive::RegisterFEdge<N>::RegisterFEdge(sc_module_name name)
	: sc_module(name)
{
	SC_METHOD(read);
	sensitive << cs << wr_bar;
...
template <int N>
void thpg::primitive::RegisterFEdge<N>::read(void)
{
	[&] {
...
template <int N>
void thpg::primitive::RegisterFEdge<N>::write(void)
{
	[&]{
